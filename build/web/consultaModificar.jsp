...
for (int i=0;i<usuario.size();i++){
	%>
            <tr>
               ...
               <th><a href="modificarProducto.jsp?idproductos=<%=usuario.get(i).getIdproducto() %> &&Nombre=<%=usuario.get(i).getNombre() %>&&Lote=<%=usuario.get(i).getLote()%>&&Cantidad=<%=usuario.get(i).getCantidad() %>&&Precio=<%=usuario.get(i).getPrecio() %>&&TipoPaletas=<%=usuario.get(i).getTipo() %>">Modificar</a></th>
